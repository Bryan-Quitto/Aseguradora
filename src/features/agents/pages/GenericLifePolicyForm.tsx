...
interface ClientProfile {
    ...
    full_name: string;
    email: string;
    fecha_nacimiento: string | null; // Añadido este campo para obtenerlo de Supabase
}

interface GenericLifePolicyFormProps {
 ...
 * Destinado a ser utilizado por agentes.
 * Se adapta según los 'coverage_details' del producto de seguro recibido.
 */
const GenericLifePolicyForm: React.FC<GenericLifePolicyFormProps> = ({ product, agentId }) => {
...
export default GenericLifePolicyForm;