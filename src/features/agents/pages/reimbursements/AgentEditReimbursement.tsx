...
export default function AgentEditReimbursement() {
    ...
    const executeSave = async (updates: Partial<ReimbursementRequestDetail>) => {
        ...
        try {
            ...
            setTimeout(() => navigate('/agent/dashboard/reimbursements'), 1500);
        } catch (err: any) {
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-lg mx-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="approvalNotes" value={approvalNotes} onChange={(e) => setApprovalNotes(e.target.value)} rows={4} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" placeholder="Ej: Se ajusta el monto según la cobertura del 80%..."></textarea>
                            </div>
                        </div>
