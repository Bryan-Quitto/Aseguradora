...
import ExpiringPoliciesReportTemplate, { EnrichedPolicy } from '../../components/ExpiringPoliciesReportTemplate';
import PageContainer from '../../../../components/container/PageContainer';

const AdminExpiringPoliciesReport = () => {
    ...
    const reportId = "expiring-policies-report-to-print";
    ...
    return (
        <PageContainer title={reportTitle} description="Página de reporte de pólizas a punto de vencer.">
            ...
            <div className="border rounded-lg p-4 shadow-sm bg-gray-50 max-h-[70vh] overflow-auto">
                {loading ? (
                    ...
                    <ExpiringPoliciesReportTemplate
                        id={reportId}
...
export default AdminExpiringPoliciesReport;