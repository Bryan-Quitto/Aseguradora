...
import AgentExpiredPoliciesReportTemplate, { EnrichedAgentPolicy } from '../../components/AgentExpiredPoliciesReportTemplate';
import PageContainer from '../../../../components/container/PageContainer';
import { useAuth } from '../../../../contexts/useAuth';

const AgentExpiredPoliciesReport = () => {
    const { user } = useAuth();
    ...
    const reportId = "agent-expired-policies-report-to-print";
    ...
    return (
        <PageContainer title={reportTitle} description="Página de reporte de mis pólizas que ya han vencido.">
            ...
            <div className="border rounded-lg p-4 shadow-sm bg-gray-50 max-h-[70vh] overflow-auto">
                {loading ? (
                    ...
                    <AgentExpiredPoliciesReportTemplate
                        id={reportId}
...
export default AgentExpiredPoliciesReport;