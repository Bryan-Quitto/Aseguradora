...
interface ExpiredPoliciesReportTemplateProps {
  id: string;
  reportTitle: string;
...
const ExpiredPoliciesReportTemplate = ({ id, reportTitle, policies, generatedAt, daysSinceExpiration }: ExpiredPoliciesReportTemplateProps) => {
    ...
    <div id={id} className="p-8 bg-white text-gray-900 font-sans text-sm">
      <header className="flex justify-between items-center pb-4 mb-6 border-b-2 border-gray-800">
        <div>
          ...
          <p className="text-gray-600 mt-1">Reporte de Pólizas Expiradas</p>
        </div>
...
export default ExpiredPoliciesReportTemplate;